  ...
  <body>
	<div class="layout-admin">
		<header class="layout-header">
			<span class="header-logo">图书馆座位预定管理系统</span>
		...
		<section class="layout-main">
			...
			<div class="layout-main-body">
				<iframe class="body-iframe" name="iframe0" width="100%" height="99%" src="${basePath}home" frameborder="0" data-id="home.jsp" seamless></iframe>
			</div>
		</section>
